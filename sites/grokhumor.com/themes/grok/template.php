 ...
 */
function internet_services_preprocess_html(&$variables, $hook) {
  $directory = drupal_get_path('theme', 'grok') . '/css/';
...
function internet_services_preprocess_page(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function internet_services_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // internet_services_preprocess_node_page() or internet_services_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function internet_services_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function internet_services_preprocess_block(&$variables, $hook) {
 ...
 */
function internet_services_preprocess_region(&$variables, $hook) {
