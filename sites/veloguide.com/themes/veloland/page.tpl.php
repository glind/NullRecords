...
?>
<div <?php print veloland_page_class($page['sidebar_first'], $page['sidebar_second']); ?>>
<div id="header">
...
<div id="slideshow-wrapper">
	<div class="slideshow-inner">
		...
		<div id="veloguide" style="width:25%; height:25%; margin: 10px;">
			<a href="http://www.veloguide.com/node/2">
			<img src="http://www.veloguide.com/sites/veloguide.com/files/images/VeloGuide-Icon.png" width="110" align="middle">
			<a/>
			<a href="http://itunes.apple.com/us/app/veloguide/id502893460?ls=1&mt=8">
			<img src="http://www.veloguide.com/sites/veloguide.com/files/images/app-store.png" width="110" border="0" align="middle">
			</a>
			<br/>
			<hr noshade width="110">
			<div align="center" id="locate">
				<h4>Bike Maps and Parking:</h4>
				<input type="radio" name="move_to" value="New York" onClick="initialize('New York')">New York</br>
				<input type="radio" name="move_to" value="Chicago" onClick="initialize('Chicago')">Chicago</br>
				<input type="radio" name="move_to" value="Portland" onClick="initialize('Portland')" checked="checked">Portland</br>
				<input type="radio" name="move_to" value="SF" onClick="initialize('SF')">San Francisco</br>
			</div>
		</div>
		<?php if ($page['preface']): ?>
		         <div id="preface">
		...
		<div id="map_canvas" style="width:820px; height:455px; float:right;"></div>
